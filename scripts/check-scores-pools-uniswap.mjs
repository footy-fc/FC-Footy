...
// Uniswap V3 Graph API endpoint for Base
...
/**
 * Make GraphQL request to Uniswap Graph
 */
...
async function getScoresPools() {
  console.log('🔍 Fetching SCORES pools from Uniswap Graph...');
 ...
 */
async function main() {
  console.log('🏊 SCORES Token Pool Analysis (Uniswap Graph)');
  console.log('=' .repeat(50));
  console.log(`📊 SCORES Token: ${SCORES_TOKEN}`);
  console.log(`📊 WETH Token: ${WETH_TOKEN}`);
  console.log(`🔗 Uniswap Graph API: ${UNISWAP_GRAPH_URL}`);
  console.log('');
